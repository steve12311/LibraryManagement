 ...
 * @author Geng Rong
 *
 * DWTech 临时补丁：基于 Spring AI 1.1.5 扩展 DeepSeek V4 thinking 参数，
 * 待上游支持后删除本模块。
 */
...
public class DeepSeekChatOptions implements ToolCallingChatOptions {
	...
	/**
	 * Controls DeepSeek V4 thinking effort. Supported values: high, max.
	 */
	...
	public int hashCode() {
		return Objects.hash(this.model, this.frequencyPenalty, this.logprobs, this.topLogprobs,
				...
				this.thinking, this.reasoningEffort,
	...
	public static DeepSeekChatOptions fromOptions(DeepSeekChatOptions fromOptions) {
		return DeepSeekChatOptions.builder()
				...
				.thinking(fromOptions.getThinking() != null ? Thinking.from(fromOptions.getThinking()) : null)
	...
	public static final class Thinking {
		...
		public static Thinking from(Thinking source) {
			return source == null ? null : new Thinking(source.getType());
		}
		...
		public boolean equals(Object o) {
			...
			return Objects.equals(this.type, thinking.type);
		}
